---
name: simple-english
description: Check documentation and code comments before a commit. Write pull request descriptions, issue descriptions, and commit messages. Use this skill only for these tasks. Do not use it for conversational replies or other technical text.
---

# Simple English: Write Like an Aerospace Manual

Adapted from `ai-dynamo/rhino@a63a717` (`.agents/skills/simple-english`), MIT licensed. Implements
ASD-STE100 Issue 9 (2025-01-15). Compatible with claude-code, codex, cursor, gemini-cli, opencode.
